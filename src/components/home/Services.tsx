      ...
      <div className="grid grid-cols-4 gap-3 py-28">
        <div className="col-span-1 space-y-3">
          ...
          <p>
            ...
            offering our top-tier detailing services to all makes and models of
            vehicles, not just high-end cars. Regardless of what you drive, our
            team is equipped with the skills and tools to make your vehicle look
            its absolute best.
          </p>
